...
/**
 * SemesterAltController implements the CRUD actions for Semester model.
 */
class SemesterAltController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax)
        {
            ...
            */
            ...
            {
                return [
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New')." Semester",
            ...
            else if($model->load($request->post()) && $model->save())
            {
                return [
                    ...
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New')." Semester",
                    'content' => '<span class="text-success">'.Yii::t('yii2-ajaxcrud', 'Create').' Semester '.Yii::t('yii2-ajaxcrud', 'Success').'</span>',
                    'footer' =>  Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => 'modal']).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax)
        {
            ...
            */
            ...
            {
                return [
                    'title' => Yii::t('yii2-ajaxcrud', 'Update')." Semester #".$id,
