...
class GridExportCustom
{
    ...
    {
        $user = 'Graduate System'; //Yii::$app->user->identity->username;
    ...
    public static function exportPdf(array $config): array
    {
        return [
            ...
            'config' => [
                'mode' => 'c',
                'format' => 'Legal-L', //A3-L A4-l   B4-L  Legal-L
                'destination' => 'D',
                'marginTop' => 15,
                'marginBottom' => 20,
                'cssInline' => '.kv-wrap{padding:20px;}' .
                    ...
                    '.header, .footer { font-family: "Cambria"; font-size: 8pt;color: #000000; }',
                'methods' => [
                    'SetHeader' => [
