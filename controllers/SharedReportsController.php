...
.panel-card--compact .panel-body { padding: 9px 10px; }
.panel-card--notes .panel-body { padding: 10px 12px; }
.panel-card--center .panel-body { text-align: center; }
.panel-body--chart { text-align: center; padding: 6px 0; }
.panel-intro { font-size: 8.1pt; color: #6c757d; margin: 0 0 6px; }
...
.chart-bar-secondary { fill: #0b3d91; }
