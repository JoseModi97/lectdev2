...
$renderPageHeader = static function () use ($logo, $courseLabel) {
    ob_start();
    ?>
...
<div class="class-performance-pdf">
    <div class="page-section page-section--summary">
        <?= $renderPageHeader(); ?>
    ...
    <div class="page-section page-section--distribution">
        <?= $renderPageHeader(); ?>
    ...
    <div class="page-section page-section--insights">
        <?= $renderPageHeader(); ?>
    ...
    <div class="page-section page-section--averages">
        <?= $renderPageHeader(); ?>
    ...
    <div class="page-section page-section--signatories">
        <?= $renderPageHeader(); ?>
