    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form id="course-analysis-filters-form" action="<?=Url::to(['/shared-reports/course-analysis'])?>" class="form-horizontal">

                    <input type="hidden" name="CourseAnalysisFilter[approvalLevel]" value="<?=$filter->approvalLevel?>">

                    <input type="hidden" name="CourseAnalysisFilter[restrictedTo]" value="<?=$filter->restrictedTo?>">

                    <div class="form-group has-feedback">
                        <label class="control-label col-sm-2 required-control-label" for="academic-year">Academic year</label>
                        <div class="col-sm-10">
                            <select id="academic-year" name="CourseAnalysisFilter[academicYear]" class="form-control" required>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-10">
                            <select id="programme" name="CourseAnalysisFilter[degreeCode]" class="form-control" required>
                                <option value="">Select</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-10">
                            <select id="level-of-study" name="CourseAnalysisFilter[levelOfStudy]" class="form-control" required>
                                <option value="">Select</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-10">
                            <select id="group" name="CourseAnalysisFilter[group]" class="form-control" required>
                                <option value="">Select</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-10">
                            <select id="semester" name="CourseAnalysisFilter[semester]" class="form-control" required>
                                <option value="">Select</option>
                            </select>
                        </div>
                    </div>
...
JS;
$this->registerJs($courseAnalysisScript, View::POS_READY);
