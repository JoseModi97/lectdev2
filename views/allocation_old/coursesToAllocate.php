...
$actionColumn = [
    ...
    'buttons' => [
        'allocate' => function ($url, $model, $key) use ($filter) {
            return Html::a(
                '<i class="fas fa-user-plus text-success"></i> <span class="text-dark">Allocate</span>',
                Url::to(
                    ['/allocation/assign', 'marksheetId' => $model->MRKSHEET_ID, 'courseType' => $filter->purpose]
                ),
                [
                    'role' => 'modal-remote',
        ...
        'remove' => function ($url, $model, $key) {
            return Html::a(
                '<i class="fas fa-trash text-danger"></i> <span class="text-dark">Remove</span>',
                Url::to(['/allocation/allocated-lecturer-render', 'marksheetId' => $model->MRKSHEET_ID, 'purpose' => 'remove']),
                [
...
<div class="allocation-grid-container" id="ajaxCrudDatatable">
    <?php
    $gridId = 'crud-datatable';
    try {
