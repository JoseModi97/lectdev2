 ...
 * @desc Email to send to a requesting department after course request has been attended to
 */
                ...
                <td class="content-cell"
                    ...
                    <div class="f-fallback">
                        <p style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;">
                            Dear HOD <?= $requestingDeptName ?>,
                        </p>

                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">
                            The lecturer request made to the department of <?= $servicingDeptName ?> for the course:
                            <?= $courseName ?> (<?= $courseCode ?>) for the academic year <?= $academicYear ?>
                            has been attended to. Please log in to the system to view the status.
                        </p>
