        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form id="course-analysis-filters-form" action="<?=Url::to(['/received-marks/courses'])?>" class="form-horizontal">
                        
                        <div class="form-group has-feedback">
                            <label class="control-label col-sm-2 required-control-label" for="academic-year">Academic year</label>
                            <div class="col-sm-10">
                                <select id="academic-year" name="ReceivedMarksFilter[academicYear]" class="form-control" required>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-10">
                                <select id="programme" name="ReceivedMarksFilter[degreeCode]" class="form-control" required>
                                    <option value="">Select</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-10">
                                <select id="level-of-study" name="ReceivedMarksFilter[levelOfStudy]" class="form-control" required>
                                    <option value="">Select</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-10">
                                <select id="group" name="ReceivedMarksFilter[group]" class="form-control" required>
                                    <option value="">Select</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-10">
                                <select id="semester" name="ReceivedMarksFilter[semester]" class="form-control" required>
                                    <option value="">Select</option>
                                </select>
                            </div>
                        </div>
