        ...
        try {
            ...
            echo GridView::widget([
                ...
                'toolbar' => [
                    [
                        'content' =>
                        Html::button('<i class="fas fa-check"></i> Approve', ['class' => 'btn btn-success', 'id' => 'approve-btn']) . ' ' .
                            Html::button('<i class="fas fa-times"></i> Disapprove', ['class' => 'btn btn-danger', 'id' => 'disapprove-btn']) . ' ' .
                            Html::a(
                ...
                <div class="card border-info mb-3">
                    ...
                    <div class="card-body text-dark">
                        <p>
                            <strong>Dean</strong> can approve or disapprove student marksheets based on the accuracy and completeness of submitted grades.
                        </p>
                        <p>
                            Click <b>"<i class="fas fa-check"></i> Approve"</b> if the marks are correct and complete, or
                            <b class="text-danger">"<i class="fas fa-times"></i> Disapprove"</b> if corrections are needed.
                        </p>
                    </div>
                </div>'
                ],
