...
Modal::begin([
    'header' => '<b>Allocate or request course lecturer(s)</b>',
...
<div class="card" style="padding:10px; margin-bottom:10px; border: 1px solid #008cba;border-radius: 5px;">
    <div class="card-body">
        <p class="card-text"><span class="text-primary">MARKSHEET: </span>
            <span class="lecturer-allocation-marksheet-id"> </span></p>
        <div class="row">
            <div class="col-md-8 col-lg-8">
                <p class="card-text"><span class="text-primary"> COURSE NAME: </span>
                    <span class="lecturer-allocation-course-name"></span> </p>
            </div>
            <div class="col-md-4 col-lg-4">
                <p class="card-text text-center"><span class="text-primary"> COURSE CODE: </span>
                    <span class="lecturer-allocation-course-code"></span></p>
            </div>
        </div>
    </div>
</div>
