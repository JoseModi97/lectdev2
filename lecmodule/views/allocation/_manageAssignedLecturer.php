...
$manageLecturersScript = <<< JS
    ...
    $('#manage-allocated-lecturers-btn').click(function(e){
        ...
        if (typeof lecturer === 'undefined')
            krajeeDialog.alert('Provide a lecturer to be a courseleader.');
        else{
            let formData = {
                '_csrf'             : _csrf,
            ...
            krajeeDialog.confirm('Are you sure you want the selected lecturer as the course leader?', function(result){
                if(result){
