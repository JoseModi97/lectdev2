    ...
    <?php
        $gridColumns = [
            ...
            [
                ...
                'template' => '{mark-scripts-view}',
                'contentOptions' => ['style'=>'white-space:nowrap;','class'=>'kartik-sheet-style kv-align-middle'],
                'buttons' => [
                    'mark-scripts-view' => function($url, $model) use($level, $type){
                        return Html::a('<i class="fas fa-check"></i> Mark returned scripts',
                            Url::to([
                                '/returned-scripts/mark-scripts-view', 
