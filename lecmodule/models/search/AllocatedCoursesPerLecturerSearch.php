...
class AllocatedCoursesPerLecturerSearch extends CourseAssignment
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search(array $params, array $additionalParams):ActiveDataProvider
    {
        $query = CourseAssignment::find()->alias('CW')
            ...
            ->where(['CW.PAYROLL_NO' => $additionalParams['payroll']])
            ->andWhere(['LIKE', 'CW.MRKSHEET_ID', $additionalParams['academicYear'] . '%', false])
