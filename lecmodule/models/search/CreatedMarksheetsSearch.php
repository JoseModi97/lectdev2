 ...
 */
class CreatedMarksheetsSearch extends MarksheetDef
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search(array $params, array $additionalParams = []):ActiveDataProvider
    {
        $query = MarksheetDef::find()->alias('MD')
            ...
            ->where(['DEPT.DEPT_CODE' => $additionalParams['deptCode']])
            ->andWhere(['like', 'MD.MRKSHEET_ID', $additionalParams['academicYear'] . '%', false])
            ->asArray();
        ...
        $query->andFilterWhere(['like', 'DEG.DEGREE_NAME', $this->getAttribute('semester.degreeProgramme.DEGREE_NAME')]);
