 ...
 * @desc Email to send lecturers added to a course
 */
                ...
                <td class="content-cell"
                    ...
                    <div class="f-fallback">
                        ...
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">
                            This is to inform you that you have been added to the course: <?= $courseName ?> (<?= $courseCode ?>) for the academic year <?= $academicYear ?>.
