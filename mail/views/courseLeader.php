 ...
 * @desc Email body to send to a new course leader 
 */
                ...
                <td class="content-cell"
                    ...
                    <div class="f-fallback">
                        ...
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">
                            This is to inform you that you have been made the course leader of <?= $courseName ?> (<?= $courseCode ?>) for the academic year <?= $academicYear ?>.
