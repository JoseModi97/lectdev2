...
//link for https://lectdev2.uonbi.ac.ke/marks/create-assessment?assessmentId=111020&type=coursework

echo BreadcrumbHelper::generate([
    ['label' => 'My Course Allocations', 'url' => ['/allocated-courses']],
    // ['label' => 'Preview Marks', 'url' => ['/marks/create-assessment?assessmentId=' . $assessmentId . '&type=' . $type]],
    // ['label'=>'Preview Marks', 'url' => ['/marks/consolidate?marksheetId=' . $marksheetId]],
    ['label' => 'Consolidated Marks']
]);
...
try {
    echo GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h5 class="panel-title text-dark">' . $panelHeading . '</h5>',
        ],
        'persistResize' => false,
        'toggleDataContainer' => [
